...
//		System.out.println(faction.getVendors().get(0).getDestinationHash());
		...
		//System.out.println(SearchDestinyPlayer.queryPlayers("Sn1pe2win32", MembershipType.PSN).getResponseData()[0].getMembershipId());
		//System.out.println(new GetProfile(MembershipType.PSN, 4611686018459652987L).getDestinyProfileComponent().getUserInfo().getDisplayName());
	}
}
